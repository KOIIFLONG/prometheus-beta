def counting_sort(arr):
    ...
    Counting Sort is an efficient sorting algorithm for integers with a limited range.
    It works by counting the number of elements with each distinct key value and 
    using that information to place elements in their correct position.
